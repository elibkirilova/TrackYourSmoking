...
//	private SharedPreferences stockSymbolsEntered;
	...
	//	stockSymbolsEntered = getSharedPreferences("stockList", MODE_PRIVATE);
		...
		stockSymbolEditText = (EditText) v. findViewById(R.id.stockSymbolEditText);
		enterStockSymbolButton = (Button) v. findViewById(R.id.enterStockSymbolButton);
		deleteStocksButton = (Button) v. findViewById(R.id.deleteStocksButton);
